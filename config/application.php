...
return array(
	...
	'SiteTitle'					=> 'ChocobotRO',	// This value is only used if the theme decides to use it.
	...
	'DateDefaultTimezone'		=> 'Australia/Sydney',		// The default timezone, consult the PHP manual for valid timezones: http://php.net/timezones (null for defaut system TZ)
	'DatabaseTimezone'			=> 'UTC',					// The timezone used by database string values; must been a valid PHP timezone (see above)
	...
	'MailerFromAddress'			=> env('MAIL_FROM', 'noreply@localhost'),		// The e-mail address displayed in the From field.
	'MailerFromName'			=> env('MAIL_NAME', 'MailerName'),			// The name displayed with the From e-mail address.
	...
	'MailerSMTPHosts'			=> env('SMTP_HOST', null),					// When MailerUseSMTP is true: A string host or array of hosts (e.g., 'host1' or array('host1', 'backuphost')).
	'MailerSMTPUsername'		=> env('SMTP_USER', null),					// When MailerUseSMTP is true: Authorized username for SMTP server.
	'MailerSMTPPassword'		=> env('SMTP_PASS', null),					// When MailerUseSMTP is true: Authorized password for SMTP server (for above user).
	...
	'ReCaptchaPublicKey'		=> env('RECAPTCHA_PUBLIC_KEY', ''),					// This is your reCAPTCHA public key [REQUIRED FOR RECAPTCHA] (sign up at http://www.google.com/recaptcha)
	'ReCaptchaPrivateKey'		=> env('RECAPTCHA_PRIVATE_KEY', ''),					// This is your reCAPTCHA private key [REQUIRED FOR RECAPTCHA] (sign up at http://www.google.com/recaptcha)
	...
	'CreditExchangeRate'		=> 0.001,						// The rate at which credits are exchanged for dollars.
...
// Service Desk
	...
	'SDEnableCreditRewards'		=> false,					// Show option in Service Desk to reward player X credits for reporting bugs/abuse/etc.
...
// Discord Webhooks
	...
	'MenuItems'		=> array(
		...
		'SocialLabel'		=> array(
			'DiscordLabel'		=> array('exturl' => 'https://discord.gg/zNYTw2N'),
